...
public class SellerFormController implements Initializable {
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		labelBirthDateError.setText((fields.contains("birthDate") ? errors.get("birthDate") : ""));
		labelBaseSalaryError.setText((fields.contains("baseSalary") ? errors.get("baseSalary") : ""));
